...
class Command(BaseCommand):
    help = 'Clear your CMS_admin from duplicates Images'
    ...
    def handle(self, *args, **options):
        ...
        # Take first image
        # Take second image and compare
        # If they match, then create new collage and main_image == first_image
        # and second_image is dulicate
        # and to the end of Images

        # If we found more then one match with first Image,
        # we not add new collage, we get collage_field in CustomImage and receive to 
        # the collage and add CustomImage in this 
